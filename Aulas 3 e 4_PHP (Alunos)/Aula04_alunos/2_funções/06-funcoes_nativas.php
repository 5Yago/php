...
<?php
$nomeY = "Yago Oliveira de Moura";
$arrayLinguagens = explode(" ", $nomeY);

?>

<pre> <?=var_dump($nomeY)?> </pre>
<pre> <?=var_dump($arrayLinguagens)?> </pre>
...
<?php
    ...
    $ataque = "<script> document.body.innerHTML = '<h1>Sou ráqui!! hahahah >_< </h1>' </script>";
